  ...
  days: [
    ...
    /* ===================== DAY 2 ===================== */
    {
      ...
      schedule: [
        ...
        { time: "8:05 AM", text: "(Optional) Jolly Holiday Bakery for a breakfast treat - Mobile order Cinnamon Rolls" },
        { time: "Morning", text: "Priority rides: Indiana Jones Adventure, Matterhorn, Space Mountain" },
        ...
        { time: "Lunch", text: "Cafe Orleans (New Orleans Square, DL)" },
        { time: "Mid-afternoon", text: "Hop to DCA — Radiator Springs Racers is Priority #1" },
        { time: "Afternoon", text: "DCA: Guardians Mission Breakout, Incredicoaster, Web-Slingers, Soarin'" },
        { time: "Dinner", text: "Try to get lamplight Lounge on the DCA waterfront — book ahead in the app" },
        { time: "10 PM", text: "DCA: World of Color" },
        { time: "10:30 PM", text: "Head back across to get one or two more rides at DL" },
      ],
      ...
      locations: [
        ...
        { icon: "🍽", name: "Cafe Orleans", note: "Lunch inside DL", map: "Cafe Orleans Disney California Adventure" },
    ...
    /* ===================== DAY 3 ===================== */
    {
      ...
      schedule: [
        ...
        { time: "Morning", text: "Drive north on US-101 — a straight shot, no major stops needed" },
    ...
    /* ===================== DAY 4 ===================== */
    {
      ...
      schedule: [
        { time: "Morning", text: "(Optional) Oceano Dunes SVRA — rent ATVs/OHVs and tear across massive sand dunes" },
    ...
    /* ===================== DAY 5 ===================== */
    {
      ...
      schedule: [
        ...
        { time: "Optional", text: "Go see Morro Rock at Sunset. 600 ft volcanic rock just 30 minutes away" },
    ...
    /* ===================== DAY 6 ===================== */
    {
      ...
      tagline: "The most beautiful 130 miles of the whole trip. Pack a dinner to eat on the cliffs of Garrapata State Park.",
      theme: "bigsur",
      stay: { name: "Embassy Suites Monterey", map: "Embassy Suites Monterey", coords: { lat: 36.6002, lon: -121.8947 } },
      drive: { from: "Pismo", to: "Monterey", duration: "~148 mi", note: "via Hwy 1 — the long pole of the trip; budget the full day, expect a late/sunset arrival" },

      schedule: [
        { time: "7:00 AM", text: "Depart Pismo Beach — this is a drive-and-stop day, take your time" },
        { time: "8:05 AM", text: "Piedras Blancas Elephant Seals — pull over 20 min, hundreds of seals on the beach" },
        { time: "Optional", text: "Salmon Creek Falls Trail - if time allows / extra early departure" },
        { time: "9:50 AM", text: "McWay Falls (Julia Pfeiffer Burns SP) — turquoise waterfall onto a cove beach. Overlook trail is officially closed but still visible from the road pullout, ~20 min" },
        { time: "10:20 AM", text: "Partington Cove — short hike through a tunnel to a hidden cove, ~20 min" },
      ...
      locations: [
        { icon: "🦭", name: "Piedras Blancas Elephant Seals", note: "Pull over 15–20 min — hundreds of massive seals", map: "Piedras Blancas Elephant Seal Rookery" },
        { icon: "💧", name: "Salmon Creek Falls Trail", note: "Quick hike with a beautiful waterfall · ~1 mi · 30 min, easy", map: "Salmon Creek Falls Trail" },
        { icon: "💧", name: "McWay Falls", note: "Turquoise waterfall onto a cove beach. Overlook trail is closed but still visible from the road. Surreal.", map: "McWay Falls Julia Pfeiffer Burns State Park" },
        { icon: "🥾", name: "Overlook Trail to McWay Falls & Saddle Rock", note: "Officially closed, but the falls are still visible from the road pullout · ~20 min", url: "https://www.alltrails.com/trail/us/california/overlook-trail-to-mcway-falls-and-saddle-rock" },
        { icon: "🥾", name: "Partington Cove Trail", note: "Tunnel through the cliff to a hidden cove · ~0.6 mi · 30–45 min, easy", url: "https://www.alltrails.com/trail/us/california/partington-cove-trail" },
        { icon: "🍽", name: "Nepenthe", note: "Lunch — cliffside terrace, 1,000-ft ocean views, the Ambrosia burger", map: "Nepenthe Big Sur" },
        { icon: "🏞", name: "Pfeiffer Big Sur State Park", note: "Pick a hike — see options below", map: "Pfeiffer Big Sur State Park" },
        { icon: "🥾", name: "Pfeiffer Falls Trail", note: "Old-growth redwood canyon · 1.4 mi loop · ~45 min–1 hr, easy", url: "https://www.alltrails.com/trail/us/california/pfeiffer-falls-trail" },
        { icon: "🥾", name: "Valley View Overlook", note: "Often combined with Pfeiffer Falls · ~1 mi · ~30–45 min, easy", url: "https://www.alltrails.com/trail/us/california/valley-view-overlook" },
        { icon: "🥾", name: "Buzzards Roost Trail", note: "Climbs to a fire-lookout viewpoint · 2.2 mi loop · ~1–1.5 hrs, moderate–strenuous", url: "https://www.alltrails.com/trail/us/california/buzzards-roost-trail" },
        { icon: "🥾", name: "Big Sur River Gorge Trail", note: "Follows the river into a narrow gorge (may involve wading) · ~3 mi out-and-back · ~1.5–2 hrs, moderate", url: "https://www.alltrails.com/trail/us/california/big-sur-river-gorge-trail" },
        { icon: "🥾", name: "Pfeiffer Beach", note: "Purple-sand beach with Keyhole Rock arch · short walk-in · ~45 min–1 hr", url: "https://www.alltrails.com/trail/us/california/pfeiffer-beach--4" },
        { icon: "🍽", name: "Nepenthe", note: "Lunch — cliffside terrace, 1,000-ft ocean views, the Ambrosia burger", map: "Nepenthe Big Sur" },
        { icon: "📸", name: "Bixby Creek Bridge", note: "Most photographed bridge in California", map: "Bixby Creek Bridge" },
        { icon: "🏞", name: "Garrapata State Park", note: "Pick a hike — see options below", map: "Garrapata State Park" },
        { icon: "🥾", name: "Soberanes Canyon Trail", note: "Lush canyon up into redwoods · 4.4 mi loop · ~2–2.5 hrs, moderate", url: "https://www.alltrails.com/trail/us/california/soberanes-canyon-trail" },
        { icon: "🥾", name: "Soberanes Point & Whale Peak", note: "Coastal bluffs, great whale-watching · 2.5 mi loop · ~1–1.5 hrs, easy–moderate", url: "https://www.alltrails.com/trail/us/california/soberanes-point-and-whale-peak" },
      ...
      links: [
        ...
        { label: "Soberanes Canyon Trail (AllTrails)", url: "https://www.alltrails.com/trail/us/california/soberanes-canyon-trail" },
        { label: "Soberanes Point and Whale Peak (AllTrails)", url: "https://www.alltrails.com/trail/us/california/soberanes-point-and-whale-peak" },
        { label: "Buzzards Roost Trail (AllTrails)", url: "https://www.alltrails.com/trail/us/california/buzzards-roost-trail" },
        { label: "Big Sur River Gorge Trail (AllTrails)", url: "https://www.alltrails.com/trail/us/california/big-sur-river-gorge-trail" },
        { label: "Pfeiffer Falls Trail (AllTrails)", url: "https://www.alltrails.com/trail/us/california/pfeiffer-falls-trail" },
        { label: "Valley View Overlook (AllTrails)", url: "https://www.alltrails.com/trail/us/california/valley-view-overlook" },
        { label: "Pfeiffer Beach (AllTrails)", url: "https://www.alltrails.com/trail/us/california/pfeiffer-beach--4" },
        { label: "Partington Cove Trail (AllTrails)", url: "https://www.alltrails.com/trail/us/california/partington-cove-trail" },
        { label: "Overlook Trail to McWay Falls and Saddle Rock (AllTrails)", url: "https://www.alltrails.com/trail/us/california/overlook-trail-to-mcway-falls-and-saddle-rock" },
      ],
